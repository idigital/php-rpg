 ...
 */
    ...
    function Smarty()
    {
      ...
      // things that will be assigned
      
      $this->template_dir = "templates/" . $_SESSION['browser'] . ( $_SESSION['language'] != "" ? $_SESSION['language'] : "english" ) . "/";
      $this->compile_dir = "templates_c/" . $_SESSION['browser'] . ( $_SESSION['language'] != "" ? $_SESSION['language'] : "english" ) . "/";
      
      $this->assign("settings",$app->settings->settingValues);      
      $this->assign("_session",$_SESSION);

      // retrieve the referer and keywords and stuff
      if ( $_COOKIE['cpa_referer_host'] == "" ){
			...
			setcookie("cpa_referer_host",$referer_host,0,'/',".connectprayaffect.com");
			setcookie("cpa_referer_keywords",$kw,0,'/',".connectprayaffect.com");
		}
